...
public class MovieOCP_Test {
    Thriller thrillerMovie = new Thriller("The Thrill", new Date(2003, 5, 23), 146);
    Romantic romanticMovie = new Romantic("The Romance", new Date(2004, 6, 25), 123);
    Horror horrorMovie = new Horror("The Horror", new Date(2005, 7, 27), 112);
